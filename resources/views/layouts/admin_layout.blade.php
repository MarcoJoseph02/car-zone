...
@section('styles')
    ...
    <script src="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.6.0/js/all.min.js" integrity="sha512-6sSYJqDreZRZGkJ3b+YfdhB3MzmuP9R7X1QZ6g5aIXhRvR1Y/N/P47jmnkENm7YL3oqsmI6AK+V6AD99uWDnIw==" crossorigin="anonymous" referrerpolicy="no-referrer"></script>    <link id="pagestyle" href="/admin/assets/css/argon-dashboard.css?v={{rand(1,999)}}" rel="stylesheet"/>
...
@section('scripts')
    ...
    <script src="/admin/assets/js/argon-dashboard.min.js?v=2.0.5"></script>
    <script src="https://code.jquery.com/jquery-1.12.4.min.js"></script>
    <script src="/admin/assets/js/core/jquery.nicescroll.js"></script>
    <script>
        $("aside").niceScroll({
            cursorcolor: "#276567"
        })
