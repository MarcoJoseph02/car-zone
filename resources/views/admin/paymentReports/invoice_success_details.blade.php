...
<table width="100%" style="font-family: 'Cairo', sans-serif; font-size: 14px;">
    <tr>
        <td>
            <table width="100%" style="font-family: 'Cairo', sans-serif; font-size: 13px; text-align: center;">
                <tr>
                    <td width="100%"
                        style="text-align: center; font-size: 16px; padding: 10px 0 10px 0; border-bottom: 2px dashed #d8d8d8; border-top: 2px dashed #d8d8d8;">
                        <strong> <a class="btn btn-default"
                                    href={{ route("admin.paymentReport.generateSuccessPdf",$row->id)  }}>
