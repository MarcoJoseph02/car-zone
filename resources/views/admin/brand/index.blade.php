        ...
        @if (!$rows->isEmpty())
            <div class="card mt-3 pt-3">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <div>
                        <a href="{{ route('admin.brand.create') }}" class="btn btn-success">Create</a>
                    </div>
                </div>
                <div class="card-body">
                                            ...
                                            <div class="row">
                                                <div class="col-md-4 col-sm-4 col-xs-4 form-group">
                                                    <a class="btn btn-xs btn-primary"
                                                        href="{{ route('admin.brand.show', $row->id) }}"
                                                        data-ps-toggle="tooltip" data-ps-placement="top" title="View">
                                                        <i class="fa fa-eye"></i>
                                                    </a>
                                                </div>
                                                <div class="col-md-4 col-sm-4 col-xs-4 form-group">
                                                    <a class="btn btn-xs btn-info"
                                                        ...
                                                        data-ps-toggle="tooltip" data-ps-placement="top" title="Edit">
                                                ...
                                                <div class="col-md-4 col-sm-4 col-xs-4 form-group">
                                                    ...
                                                    <div class="modal fade" id="delete_course_{{ $row->id }}"
